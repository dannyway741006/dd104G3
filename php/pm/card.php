...
try {
  ...
  switch ($_POST['type']) {
    ...
    case "add_todo_content":
      ...
      echo json_encode(['status' => 'success', 'content' => '更新待辦事項成功', 'todo_cont_no' => $todos_cont_id]);
    ...
    case "add_file":
      ...
      $files->execute();
      $files_id = $pdo->lastInsertId();
      echo json_encode(['status' => 'success', 'content' => '上傳檔案成功','file_no'=>$files_id]);
